...
<?php else: ?>
  ...
  <nav class="navbar navbar-expand-sm navbar-light bg-white p-3 mb-3 border-bottom shadow-sm">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item"><a class="nav-link" href="<?php echo Config::ROOT; ?>index.php?cat=search">Search</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo Config::ROOT; ?>index.php?cat=chatroom">Chat room</a></li>
